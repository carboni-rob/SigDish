			...
			<View>
				<View style={styles.header}>
					<View style={styles.headerLeft}>
						<TouchableOpacity onPress={this.props.left} style={{flex: 1, flexDirection: 'row', alignItems: 'center'}} >
					...
					<View  style={styles.headerRight}>
						<TouchableOpacity onPress={this.props.right} style={{flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end'}} >
